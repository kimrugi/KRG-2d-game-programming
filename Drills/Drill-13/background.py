...
class InfiniteBackground:
    ...
    def update(self):
            ...
            # quadrant 2
            self.q2l = self.w - (int(self.center_object.x) - self.canvas_width // 2) % self.w
            self.q2b = (int(self.center_object.y) - self.canvas_height // 2) % self.h
            self.q2w = (int(self.center_object.x) - self.canvas_width // 2) % self.w
            self.q2h = (int(self.center_object.y) - self.canvas_height // 2) % self.h
